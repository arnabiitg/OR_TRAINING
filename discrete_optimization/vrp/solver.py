...
from solution2 import clarke_wright_algo
from trivial_heuristic import main
...
def solve_it(input_data):
    ...
    obj, vehicle_tours = clarke_wright_algo(customers, vehicle_count, vehicle_capacity)

    if obj == -1:
        obj, vehicle_tours = main(customers,vehicle_count, vehicle_capacity)
    ...
    for index in range(vehicle_count - len(vehicle_tours)):
